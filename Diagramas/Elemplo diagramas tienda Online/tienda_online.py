...
class Cliente:
    def __init__(self, id: Optional[int] = None, nombre: Optional[str] = None, apellido: Optional[str] = None, email: Optional[str] = None):
        self.id = id
        self.nombre = nombre
    ...
    def __repr__(self):
        return f"Cliente(id={self.id!r}, nombre={self.nombre!r}, apellido={self.apellido!r}, email={self.email!r})"
